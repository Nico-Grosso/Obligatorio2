...
sh echo "=============================================="
client tcpdump -i any -w jsonrpc_test_client.pcap > /dev/null 2>&1 &
vhost1 tcpdump -i any -w jsonrpc_test_vhost1.pcap > /dev/null 2>&1 &
vhost2 tcpdump -i any -w jsonrpc_test_vhost2.pcap > /dev/null 2>&1 &
vhost3 tcpdump -i any -w jsonrpc_test_vhost3.pcap > /dev/null 2>&1 &
server1 tcpdump -i any -w jsonrpc_test_server1.pcap > /dev/null 2>&1 &
server2 tcpdump -i any -w jsonrpc_test_server2.pcap > /dev/null 2>&1 &
sh sleep 2
